...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_tooltips__ = __webpack_require__(581);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__search__ = __webpack_require__(583);
...
var SearchPageModule = /** @class */ (function () {
    ...
    SearchPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__search__["a" /* SearchPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */],
                __WEBPACK_IMPORTED_MODULE_2_ionic_tooltips__["a" /* TooltipsModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__search__["a" /* SearchPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_4__search__["a" /* SearchPage */],
            ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_animations__ = __webpack_require__(140);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tooltip_box_component__ = __webpack_require__(445);
...
;(function (global, factory) {
    true ? factory(__webpack_require__(444)) :
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tooltip_box_component__ = __webpack_require__(445);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tooltip_directive__ = __webpack_require__(446);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tooltips_module__ = __webpack_require__(582);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tooltip_box_component__ = __webpack_require__(445);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tooltip_directive__ = __webpack_require__(446);
...
var TooltipsModule = (function () {
    ...
    TooltipsModule.decorators = [
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */], args: [{
                    entryComponents: [__WEBPACK_IMPORTED_MODULE_2__tooltip_box_component__["a" /* TooltipBox */]],
                    declarations: [__WEBPACK_IMPORTED_MODULE_3__tooltip_directive__["a" /* Tooltip */], __WEBPACK_IMPORTED_MODULE_2__tooltip_box_component__["a" /* TooltipBox */]],
                    imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicModule */]],
                    exports: [__WEBPACK_IMPORTED_MODULE_3__tooltip_directive__["a" /* Tooltip */]]
                },] },
    ];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_moment__ = __webpack_require__(444);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_file_chooser__ = __webpack_require__(263);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_path__ = __webpack_require__(264);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_forms__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ionic_angular__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9____ = __webpack_require__(261);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers__ = __webpack_require__(139);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SearchPage = /** @class */ (function () {
    ...
    SearchPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.user.getUserName().then(function (response) {
            if (response) {
    ...
    SearchPage.prototype.doSearch = function () {
        var _this = this;
        this.document = this.search_form.value.document;
        this.document_type = this.search_form.value.document_type;
        this.payment_type = this.search_form.value.payment_type;
        if (this.document == "") {
            this.showAlert(this.searchErrorString, this.searchErrorMsgString);
            return;
        }
        var type = this.document_type == "2" ? "3" : this.document_type;
        if (this.process_step == 8) {
            this.process_step = 0;
            this.document = "";
        }
        else {
            ...
            this.nomination.hermeco(this.document, type).subscribe(function (result) {
                ...
                _this.nomination.consult(body).subscribe(function (result) {
                    ...
                    _this.loading.dismiss();
                    console.log(error);
                    _this.showAlert(_this.sessionErrorString, _this.sessionErrorMsgString);
                    _this.navCtrl.pop();
                    _this.doLogout();
                });
            }, function (error) {
     ...
     * Method validateUser
     */
    SearchPage.prototype.validateUser = function () {
        var _this = this;
        this.first_last_name = this.validation_form.value.first_last_name;
     ...
     * @param data any
     */
    SearchPage.prototype.doValidator = function (data) {
        var _this = this;
        var answers = [];
     ...
     * Method next
     */
    SearchPage.prototype.doNext = function () {
        var _this = this;
        this.showLoader(this.loadingString);
        var body = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["e" /* HttpParams */]()
            .append('UserName', this.username)
     ...
     * @param data
     */
    SearchPage.prototype.process = function (data) {
        var _this = this;
        this.showToast(this.alertString);
        if (data.success == 0) {
            console.log("Error: ", data.Message);
        }
        var stage_proccess = data.UserData.StageProcess;
        var state = data.UserData.State;
        var score = data.UserData.Score;
        if (stage_proccess == 1 && state == 2) {
            this.process_step = 1.5;
        }
        if (stage_proccess == 1 && state == 4) {
            this.process_step = 2.6;
        }
        if (stage_proccess == 1 && state == 3) {
            this.process_step = 2.8;
        }
        if (stage_proccess == 2 && state == 4) {
            this.process_step = 2.7;
            this.error_message = data.UserData.Message;
        }
        if (stage_proccess == 10 && state == 0) {
            this.process_step = 2;
        }
        if (stage_proccess == 3 && state == 0) {
            var questions = data.Question;
            var questionnaire = data.UserData.SecuenciaCuestionario;
            this.questions = questions;
            this.questionnaire = questionnaire;
            this.process_step = 3;
        }
        if (stage_proccess == 3 && state == 2) {
            this.process_step = 2.5;
        }
        if (stage_proccess == 3 && state == 3) {
            this.process_step = 2.7;
            this.error_message = data.UserData.Message;
        }
        if (stage_proccess == 3 && state == 4) {
            this.process_step = 2.6;
        }
        if (stage_proccess == 3 && state == 6) {
            this.process_step = 2.7;
            this.error_message = data.UserData.Message;
        }
        if (stage_proccess == 4 && state == 1) {
            this.score = score;
            this.process_step = 4;
            this.payment_type = data.UserData.PaymentType;
        }
        if (stage_proccess == 4 && state == 2) {
            this.process_step = 4.2;
        }
        if (stage_proccess == 5 && state == 0) {
            this.process_step = 7;
            this.payment_type = data.FormData.tipoSolicitud;
            this.campaign = data.FormData.campana;
            this.campaign_id = data.FormData.campanaId;
            this.first_name = data.FormData.nombre;
            this.last_name = data.FormData.apellido;
            this.zone = data.FormData.CodigoZona;
            this.zone_id = data.FormData.ZoneId;
            var today_min = new Date();
            var today_max = new Date();
            today_min.setHours(0, 0, 0);
            today_max.setHours(0, 0, 0);
            var min = today_min;
            var max = today_max;
            min.setFullYear(today_min.getFullYear() - 100);
            max.setFullYear(today_max.getFullYear() - 18);
            this.minDate = min.toISOString().substring(0, 10);
            this.maxDate = max.toISOString().substring(0, 10);
            this.nomination.departments().subscribe(function (result) {
                _this.departments = result;
            }, function (error) {
                console.log(error);
            });
        }
        if (stage_proccess == 6 && state == 0) {
            this.score = score;
            this.process_step = 8;
        }
        if (stage_proccess == 6 && state == 1) {
            this.score = score;
            this.process_step = 9;
        }
        if (stage_proccess == 7 && state == 1) {
            this.score = score;
     ...
     * @param event any
     */
    SearchPage.prototype.departmentChange = function (event) {
        var _this = this;
        this.nomination.cities(event).subscribe(function (result) {
            _this.cities = result;
        }, function (error) {
            console.log(error);
        });
    ...
    /**
     * Method departmentFamChange
     * @param event any
     */
    SearchPage.prototype.departmentFamChange = function (event) {
        var _this = this;
        this.nomination.cities(event).subscribe(function (result) {
            _this.cities_fam = result;
        }, function (error) {
            console.log(error);
        });
    };
    ...
    /**
     * Method livingPlaceChange
     * @param event any
     */
    SearchPage.prototype.livingPlaceChange = function (event) {
        if (event == 2) {
            this.show_living_place = true;
        }
        else {
            this.show_living_place = false;
    ...
    /**
     * Method businessChange
     * @param event any
     */
    SearchPage.prototype.businessChange = function (event) {
        clearTimeout(this.wait);
        var self = this;
        if (event.target.value.length >= 5 && event.target.value.length <= 11) {
            this.wait = setTimeout(function () {
                self.search_business(event.target.value);
            }, 3000);
        }
    };
    /**
            ...
            if (result['Success'] == 1) {
                ...
                if (_this.zone == code) {
                    if (_this.business_rank == "EI" || _this.business_rank == "DIR_ZON" || _this.business_rank == "EMP_COM") {
                        ...
                        _this.referrer_rank = "";
                        _this.loading.dismiss();
                        _this.showAlert(_this.searchErrorString, _this.invalidRankString);
                    }
                }
                else {
                    _this.show_business = false;
                    ...
                    _this.referrer_rank = "";
                    _this.loading.dismiss();
                    _this.showAlert(_this.searchErrorString, _this.invalidZoneString);
                }
            }
            else {
                _this.show_business = false;
                ...
                _this.referrer_rank = "";
                _this.loading.dismiss();
                _this.showAlert(_this.searchErrorString, _this.notFountString);
            }
        });
    };
    /**
     * Method referrerChange
     * @param event any
     */
    SearchPage.prototype.referrerChange = function (event) {
        clearTimeout(this.wait);
        var self = this;
        if (event.target.value.length >= 5 && event.target.value.length <= 11) {
            this.wait = setTimeout(function () {
                self.search_referer(event.target.value);
            }, 3000);
        }
    };
    /**
     * Method search_referer
     * @param value any
     */
     ...
     * Method doSendForm
     */
    SearchPage.prototype.doSendForm = function () {
        var _this = this;
        this.genre = this.user_form.value.genre;
        this.birthdate = this.user_form.value.birthdate;
        this.email = this.user_form.value.email;
        this.direction_one = this.user_form.value.direction_one;
        this.direction_two = this.user_form.value.direction_two;
        this.direction_three = this.user_form.value.direction_three;
        this.direction_four = this.user_form.value.direction_four;
        this.direction_five = this.user_form.value.direction_five;
        this.neighborhood = this.user_form.value.neighborhood;
        this.phone = this.user_form.value.phone ? this.user_form.value.phone : null;
        this.cell_phone = this.user_form.value.cell_phone;
        ...
        var answers = {
            ...
            email: this.email,
            direccion1: this.direction_one,
            direccion2: this.direction_two,
            direccion3: this.direction_three,
            direccion4: this.direction_four,
            direccion5: this.direction_five,
            barrio: this.neighborhood,
            telefono: this.phone,
            celular: this.cell_phone,
            departamento: this.department,
            ciudad: this.city,
            vivienda: this.living_place,
            catalogos: this.catalogs,
            referenciaFamiliar: this.referral,
            departamentoFam: this.department_fam,
            ciudadFam: this.city_fam,
            telefonoRefFamiliar: this.phone_fam,
            tipoDocumentoEmpresariaECO: this.business_document_type,
            empresariaECO: this.business_document,
            nombreEmpresariaECO: this.business_name,
            rankEmpresariaECO: this.business_rank,
            tipoCedulaReferidor: this.referrer_document_type,
            cedulaReferidor: this.referrer_document,
            nombreReferidor: this.referrer_name,
            rankReferidor: this.referrer_rank,
            nombreArrendador: this.lessor_name,
            telefonoArrendador: this.lessor_phone,
            celularArrendador: this.lessor_cell_phone,
        };
        this.showLoader(this.loadingString);
        var body = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["e" /* HttpParams */]()
            .append('UserName', this.username)
     ...
     * Method doExit
     */
    SearchPage.prototype.doExit = function () {
        this.showLoader(this.loadingString);
        this.process_step = 0;
    ...
    SearchPage.prototype.openModal = function () {
        this.modal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_9____["c" /* Modal */], {
            data: {
                status: this.status,
                ...
                business_rank: this.business_rank,
                referrer_name: this.referrer_name,
                referrer_rank: this.referrer_rank,
                form: this.user_form,
            },
            send: this.doSendForm.bind(this),
        });
        this.modal.present();
    };
    /**
     * Function bussiness_level
     * @param document_type_key
     * @param payment_type_key
     */
    SearchPage.prototype.bussiness_level = function (document_type_key, payment_type_key) {
        return function (group) {
            var payment_type = group.controls[payment_type_key];
     ...
     * Method doLogout
     */
    SearchPage.prototype.doLogout = function () {
        var _this = this;
     ...
     */
    SearchPage.prototype.showLoader = function (message) {
     ...
     * @param message
     */
    SearchPage.prototype.showAlert = function (title, message) {
        this.alert = this.alertCtrl.create({
            title: title,
            message: message,
            buttons: [{
    ...
    SearchPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_10__providers__["c" /* User */],
            ...
            __WEBPACK_IMPORTED_MODULE_10__providers__["b" /* Nomination */],
            __WEBPACK_IMPORTED_MODULE_7__angular_forms__["a" /* FormBuilder */],
            __WEBPACK_IMPORTED_MODULE_8_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_8_ionic_angular__["m" /* ToastController */],
